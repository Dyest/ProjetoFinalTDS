...
namespace delivery
{
    public static class AppUtils
    {
        ...
        {
            //copia a imagem para um stream em mem처ria
            var ms = new MemoryStream();
            await imagemProduto.CopyToAsync(ms);

            //carrega o stream em mem처ria para o objeto de processamento de imagem
            ms.Position = 0;
            ...
            //cria um ret창ngulo de recorte para deixar a imagem quadrada
            ...
            //recorta a imagem usando o ret창ngulo computado
